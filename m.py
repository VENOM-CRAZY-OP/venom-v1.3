...
bot = telebot.TeleBot('7254663003:AAEc6e50A6SK_n2GCJRfX7qfFLeprTJguO8')
...
1. Run Too Many Attacks !! Cause A Ban From Bot
2. Run 2 Attacks At Same Time Becz If U Then U Got Banned From Bot.
